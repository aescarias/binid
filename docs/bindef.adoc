...
For example, the Executable and Linkable Format includes multiple integer fields that may be described as enumerations. In this case, we will describe the values of the `e_ident[E_OSABI]` field as shown below.
